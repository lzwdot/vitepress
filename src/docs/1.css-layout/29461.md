...
<div class="box box1">
  <div class="col1">width:100px</div>
  <div class="col2">
    <pre>
        display: flex;        
        flex-grow: 1;
  ...
  <div class="col3">width: 200px;</div>
</div>
<div class="box box2">
  <div class="col1">width:100px; float: left;</div>
  <div class="col2">
    <pre>
            overflow: hidden;
        </pre
...
<div class="box box1">
  <div class="header">height: 100px;</div>
...
```html
<link
  href="https://cdn.bootcdn.net/ajax/libs/reseter.css/2.0.0/reseter.min.css"
  rel="stylesheet"
/>
<style>
  @font-face {
...
<div class="swiper-container">
  <div class="swiper-wrapper">
    <div class="swiper-slide">
      <img src="https://fakeimg.pl/789x1242/698" alt="" />
    </div>
    <div class="swiper-slide">
      <img src="https://fakeimg.pl/113x1242/698" alt="" />
    </div>
    <div class="swiper-slide">
      <img src="https://fakeimg.pl/104x1242/698" alt="" />
    </div>
  </div>
  <!-- 如果需要分页器 -->
